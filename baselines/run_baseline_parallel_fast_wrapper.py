...
def make_env(rank, env_conf, seed=0):
    def _init():
        ...
        return StreamWrapper(  # Wrap each environment instance
                env,
                stream_metadata={
                    "user": "Aedifex",  # Specify your username
                    "env_id": f"Epischer Onkel_{rank}", # Unique environment ID for each instance
                    "color": "#0033ff",  # Customize the color if needed
...
if __name__ == '__main__':
    ...
    file_name = 'session_9d46ead0/poke_655360_steps' 
